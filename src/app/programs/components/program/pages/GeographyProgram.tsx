  ...
  const highlights = [
    {
      ...
      text: "Comprehensive syllabus coverage"
    },
    {
      icon: <FiMap className="w-6 h-6" />,
      text: "Maps and diagram practice"
    },
    {
    ...
    },
    {
      ...
      text: "Previous year question analysis"
    }
  ];
    ...
    <section className="py-16 bg-gray-50">
      <div className="container mx-auto px-4">
        ...
        <p className="text-center text-gray-600 mb-12">
          Success stories from Geography Optional students
        </p>
    ...
    <section className="py-16 bg-blue-900 text-white">
      <div className="container mx-auto px-4 text-center">
        <p className="text-lg mb-8">
          Join Geography Optional at iLearn IAS Academy and take the first step towards
