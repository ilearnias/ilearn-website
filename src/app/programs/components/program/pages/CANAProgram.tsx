...
const WhyCANAMatters = () => {
  ...
  return (
    <section className="py-12 sm:py-20 bg-gray-50">
      <Container>
        <Heading text="Why CANA Matters" className="text-center mb-4 sm:mb-6" />
...
const CANAFeatures = () => {
  ...
  return (
    <section className="py-16 bg-gray-50">
      ...
      `}</style>
      <Container>
        <Heading text="Program Features" className="text-center mb-6" />
    ...
    <>
      ...
      >
        ...
        <div className="px-4 pb-4 pt-2">
          <p className="text-gray-600 leading-relaxed ml-[4.5rem]">{description}</p>
        </div>
      </details>
  ...
  return (
    <>
      <section className="py-20 bg-gray-50">
        ...
        `}</style>
        <Container>
          <Heading text="What Makes Our CANA Special?" className="text-center mb-6" />
      ...
      <section className="py-20 bg-white">
        <Container>
          <Heading text="CANA Success Impact" className="text-center mb-6" />
