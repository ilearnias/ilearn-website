...
const testimonialItems: TestimonialItem[] = [
  {
    ...
    subtitle: "Listen to Priya's inspiring journey from a small town to becoming an IAS officer. Her dedication and our guidance made her dream come true.",
    videoId: "Y8Tko2YC5hA",
  ...
  },
  {
    ...
    subtitle: "Rahul shares his strategy and experience of clearing UPSC in his very first attempt with AIR under 100.",
    videoId: "jNQXAC9IVRw",
  ...
  },
  {
    ...
    subtitle: "Watch how Meera's persistent effort and our mentorship helped her achieve her dream of joining the Indian Foreign Service.",
    videoId: "M7lc1UVf-VE",
            ...
            {testimonials.map((item) => (
              <div key={item.id} className="relative mb-4">
                <motion.button
                  ...
                  animate={{ 
                    backgroundColor: openDropdownId === item.id ? '#F3F4F6' : '#FFFFFF',
                  }}
                >
                    ...
                    >
                      ...
                      >
                        <VideoCard
                          ...
                          videoUrl={activeVideo === item.videoId 
