    ...
    <Col md={4}>
      ...
      >
        <div className="review-header" style={{ display: 'flex', alignItems: 'center', marginBottom: '10px' }}>
          <div className="review-avatar-wrapper" style={{ paddingLeft: '10px', paddingRight: '16px', position: 'relative', width: 60, height: 60 }}>
            <Image
              src="/About/team/dummy.jpg"
              alt="User Avatar"
              fill
              className="rounded-full object-cover"
              style={{ border: '2px solid #eee', boxShadow: '0 2px 8px rgba(0,0,0,0.08)' }}
            />
          </div>
          <div style={{ flex: 1 }}>
