...
export default function GalleryComponent({ images, className = '' }: GalleryProps) {
  const [selectedIndex, setSelectedIndex] = useState<number | null>(null);

  return (
    <div className={`min-h-screen w-full bg-gradient-to-b from-black via-gray-600 to-gray-600 relative ${className}`}>
